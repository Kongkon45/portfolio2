...
const Contact = () => {
  ...
  return (
    <div id="contact" className="relative container py-10">
      <h3 className="text-4xl font-bold text-center">Contact Me</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10">
        ...
        <div className="bg-gray-900 p-8 rounded-lg">
          <h4 className="text-4xl font-bold text-white pb-5">
            Get in Touch
          </h4>
